  ...
  return (
    <div className="min-h-screen bg-background flex flex-col justify-center items-center p-4">
      <div className="w-full max-w-md bg-card p-8 rounded-3xl shadow-2xl border border-border animate-in fade-in slide-in-from-bottom-8 duration-500">
        ...
        <h2 className="text-3xl font-black text-center text-foreground mb-2">Bienvenido de nuevo</h2>
        <p className="text-center text-muted-foreground mb-8 font-medium">Inicia sesión para continuar organizando tu día.</p>
